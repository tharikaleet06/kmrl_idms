...
import { fetchDocuments, uploadDocument, fetchCompliance, fetchAuditLogs } from '../frontend/services/api.js';
import { isTabAllowedForRole, getTabFromPath, getPathFromTab, getDefaultTabForRole } from '../frontend/utils/roleAccess.js';
...
import { LoginPage } from '../frontend/components/LoginPage.jsx';
import { DashboardView } from '../frontend/components/DashboardView.jsx';
import { DocumentUploadView } from '../frontend/components/DocumentUploadView.jsx';
import { MyDocumentsView } from '../frontend/components/MyDocumentsView.jsx';
import { SemanticSearchView } from '../frontend/components/SemanticSearchView.jsx';
import { WorkflowApprovalView } from '../frontend/components/WorkflowApprovalView.jsx';
import { GeospatialOcrView } from '../frontend/components/GeospatialOcrView.jsx';
import { ComplianceView } from '../frontend/components/ComplianceView.jsx';
import { AuditTrailView } from '../frontend/components/AuditTrailView.jsx';
import { MicroservicesConsoleView } from '../frontend/components/MicroservicesConsoleView.jsx';
import { UserManagementView } from '../frontend/components/UserManagementView.jsx';
import { NotificationsView } from '../frontend/components/NotificationsView.jsx';

import { ProfileView } from '../frontend/components/ProfileView.jsx';
import { AccessDeniedView } from '../frontend/components/AccessDeniedView.jsx';
import { DocumentDetailModal } from '../frontend/components/DocumentDetailModal.jsx';
          ...
          <ErrorBoundary key={activeTab}>
            {!isAllowed ? (
              ...
              <>
                ...
                {activeTab === 'compliance' && <ComplianceView complianceRecords={complianceRecords} userRole={currentUser.role} onToast={triggerToast} />}
